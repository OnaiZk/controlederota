...
type ToastFunction = {
  ...
  create: typeof toastManager.add;
...
const toast: ToastFunction = Object.assign(
  (options: ToastOptions | string) => {
    if (typeof options === "string") {
      return toastManager.add({ description: options })
    }
    const type = options.variant === "destructive" ? "error" : options.type
  ...
  toastManager,
  {
    create: toastManager.add.bind(toastManager),
...
function Toaster({
  children,
  toastManager = toastManagerDefault,
  ...props
...
const toastManagerDefault = toastManager
